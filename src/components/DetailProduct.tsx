import { Cart_Add, Product, Star } from "../common/icons"
        ...
        <div className="detail-product flex flex-row justify-between mt-[105px]">
          <div className="flex flex-col detail-img flex-grow">
            <div className="flex-grow ">
              <img src={Product} alt="" className="size-[355px]" />
            </div>
          ...
          <div className="detail-info ">
            <span className="detail-tag">Plant</span>
            ...
            <div className="detail-price">
              ...
              <div className="detail-origin-price">$250.00</div>
            </div>
